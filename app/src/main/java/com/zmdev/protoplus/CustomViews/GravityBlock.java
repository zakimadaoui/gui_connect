...
import static com.zmdev.protoplus.CustomViews.ProtoView.Type.VIEW_TYPE_GRAVITY;

public class GravityBlock extends LinearLayout
    ...
    private static final String TAG = "GravityBlock";

    public GravityBlock(@NonNull Context context, AttrsAndCommand attrs) {
        super(context);
    ...
    private void init(Context context){
        ...
        inflater.inflate(R.layout.sensor_gravity_layout, this);
        ...
        sensor_gyro = sensorManager.getDefaultSensor(Sensor.TYPE_GRAVITY);
    ...
    public static ProtoViewAttrs getPreviewAttrs() {
        ...
        attrs.setViewType(VIEW_TYPE_GRAVITY);
        attrs.setPreviewTitle("Gravity block");
        attrs.setX(0);
        attrs.setY(0);
        return attrs;
    }
    ...
    public Command getDefCommand() {
        Command cmnd = new Command(0,"gravity",null,
                new Parameter[]{
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        data_text.setText(String.format("x: %+.2f\ny: %+.2f\nz: %+.2f\ng", val[0],val[1],val[2]));
    ...
    public int[] getViewDetailsArray(){
        return new int[]{
                R.string.doc_gravity_desc,
                R.string.doc_gravity_reqs,
                R.string.doc_gravity_usage
        };
    }
}
