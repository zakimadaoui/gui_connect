...
public class GyroBlock extends LinearLayout
    ...
    public GyroBlock(@NonNull Context context, AttrsAndCommand attrs) {
        super(context);
    ...
    private void init(Context context){
        ...
        inflater.inflate(R.layout.sensor_gyro_layout, this);
    ...
    public static ProtoViewAttrs getPreviewAttrs() {
        ...
        attrs.setViewType(VIEW_TYPE_GYRO);
        attrs.setPreviewTitle("Gyro block");
        attrs.setX(0);
        attrs.setY(0);
        return attrs;
    }
    ...
    public Command getDefCommand() {
        Command cmnd = new Command(0,"gyro",null,
                new Parameter[]{
    ...
    public int[] getViewDetailsArray(){
        return new int[]{
                R.string.doc_gyro_desc,
                R.string.doc_gyro_reqs,
                R.string.doc_gyro_usage
        };
    }
