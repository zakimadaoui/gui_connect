...
import static com.zmdev.protoplus.CustomViews.ProtoView.Type.VIEW_TYPE_PROXIMITY;

public class ProximityBlock extends LinearLayout
        implements ProtoView, CompoundButton.OnCheckedChangeListener, SensorEventListener {

    private int sampling_rate = 50*1000; //50ms
    ...
    public ProximityBlock(@NonNull Context context, AttrsAndCommand attrs) {
        super(context);
    ...
    private void init(Context context){
        ...
        inflater.inflate(R.layout.sensor_proximity_layout, this);
        ...
        sensor_gyro = sensorManager.getDefaultSensor(Sensor.TYPE_PROXIMITY);
    ...
    public static ProtoViewAttrs getPreviewAttrs() {
        ...
        attrs.setViewType(VIEW_TYPE_PROXIMITY);
        attrs.setPreviewTitle("Proximity sensor");
        return attrs;
    }
    ...
    public Command getDefCommand() {
        Command cmnd = new Command(0,"prox",null,
                new Parameter[]{
                        new Parameter("0","isClose", 1,DEF_COMMAND),
                });
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        String val = event.values[0] != 0.0 ? "0" : "1";
        data_text.setText(val);
        parameters[paramIndex].setDefValue(val);
    ...
    public int[] getViewDetailsArray(){
        return new int[]{
                R.string.doc_proximity_desc,
                R.string.doc_proximity_reqs,
                R.string.doc_proximity_usage
        };
    }
}
