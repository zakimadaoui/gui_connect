...
public class AccBlock extends LinearLayout
        implements ProtoView, CompoundButton.OnCheckedChangeListener, SensorEventListener {

    private int sampling_rate = 100*1000; //50ms
    ...
    public AccBlock(@NonNull Context context, AttrsAndCommand attrs) {
        super(context);
    ...
    private void init(Context context){
        ...
        inflater.inflate(R.layout.sensor_acc_layout, this);
        ...
        sensor_gyro = sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
    ...
    public static ProtoViewAttrs getPreviewAttrs() {
        ...
        attrs.setViewType(VIEW_TYPE_ACC);
        attrs.setPreviewTitle("Accelerometer block");
        attrs.setX(0);
        attrs.setY(0);
        return attrs;
    }
    ...
    public Command getDefCommand() {
        Command cmnd = new Command(0,"acc",null,
                new Parameter[]{
